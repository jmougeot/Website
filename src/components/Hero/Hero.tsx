...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className=" min-h-screen">
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', margin: '0 auto', padding: '160px 24px', textAlign: 'left' }}>
        <div>
          {/* Name */}
          ...
          <p
            ...
            style={{ color: 'var(--text-tertiary)', fontSize: '18px', margin: '0 auto 48px auto'}}
          >
            {t.hero.description}
          </p>

          {/* CTA buttons */}
          <div className="animate-in delay-4" style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '56px' }}>
            <a
              href="#contact"
          ...
          {/* Social */}
          <div className="animate-in delay-5" style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
            {[
